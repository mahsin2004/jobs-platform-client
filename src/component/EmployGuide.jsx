const EmployGuide = () => {
  return (
    <div className="max-w-[1440px] mx-auto px-10 pb-28 pt-20">
      <div className="lg:flex lg:justify-between">
        ...
        <div className="space-y-8 text-white bg-[#1f57c3] lg:rounded-br-xl lg:rounded-tr-xl px-10 py-16">
          ...
          <button className="text-xl text-[#1f57c3] bg-white px-6 py-2 rounded-full">
            Find opportunities
          </button>
        </div>
      </div>
